...
import '../../features/notification/presentation/controller/get_unreaded_count_cubit/get_un_readed_count_cubit.dart';
...
Future<void> _setupNotificationFeature() async {
  ...
  injector.registerFactory<GetUnReadedCountCubit>(
    () => GetUnReadedCountCubit(
      notificationRepo: injector<NotificationRepo>(),
    ),
  );
